      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            transition={{ duration: 0.2 }}
            className="absolute z-50 w-full mt-2 bg-white dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-lg shadow-xl overflow-hidden backdrop-blur-sm"
          >
